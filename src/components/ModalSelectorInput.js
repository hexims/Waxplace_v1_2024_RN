...
export default class ModalSelector extends React.Component {
  ...
  renderOption = (option, isLastItem, isFirstItem) => {
    ...
    let component = optionComponent || (
      <Text
        style={[
          styles.optionTextStyle(this.props.colors),
          this.props.optionTextStyle,
          isSelectedItem && {color: this.props.colors.waxplaceColor},
        ]}
    ...
    return (
      <TouchableOpacity
        ...
        <View
          style={[
            styles.optionStyle(this.props.colors),
      ...
      <Overlay {...overlayProps}>
        <View style={[styles.overlayStyle, overlayStyle]}>
          <View
            ...
            {search && (
              <View style={[styles.searchStyle(colors), searchStyle]}>
                <TextInput
                  style={{
                    fontSize: 22,
          ...
          <View style={[styles.cancelContainer, cancelContainerStyle]}>
            <TouchableOpacity
              ...
              <View style={[styles.cancelStyle(colors), cancelStyle]}>
                <Text
                  style={[styles.cancelTextStyle(colors), cancelTextStyle]}
  ...
  renderChildren = () => {
    ...
    let initSelectStyle =
      this.props.initValue === this.state.selected
        ...
        : [styles.selectTextStyle(colors), this.props.selectTextStyle];
    return (
      ...
      <View style={this.props.style} {...this.props.passThruProps}>
        ...
        {this.props.customSelector ? (
          ...
          <TouchableOpacity
            ...
            <View style={{height: 43}} pointerEvents="none">
              {this.renderChildren()}
            </View>
          </TouchableOpacity>
        )}
...
const styles = StyleSheet.create({
  ...
  optionContainer: colors => ({
    borderRadius: BORDER_RADIUS,
    flexShrink: 1,
    marginBottom: 8,
    padding: PADDING,
    backgroundColor: colors !== {} ? colors.cardColor : 'rgba(255,255,255,0.8)',
    maxHeight: '60%',
  }),
